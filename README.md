...
`vim.pack` writes `nvim-pack-lock.json` to the active Neovim config directory.

After updating plugins in the rsynced config, copy the lockfile back into this repo
before committing:
